...
function ReviewResume() {
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = `resume-review-${Date.now()}.txt`;
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex  gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        {fileName && (
          <div className='mt-4 p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center gap-3 animate-in fade-in slide-in-from-top-1'>
            ...
            <div className='flex-1 min-w-0'>
              ...
              <p className='text-[10px] text-slate-400 uppercase tracking-tighter'>Selected PDF</p>
            </div>
          </div>
        )}
